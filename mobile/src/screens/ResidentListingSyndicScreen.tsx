...
interface ResidentListingSyndicScreenProps {
  onGoBack: () => void;
  onRegisterResident: () => void;
...
export function ResidentListingSyndicScreen({
  onGoBack,
  onRegisterResident,
  onOpenResidentDetails,
  onPressTab,
}: ResidentListingSyndicScreenProps) {
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.panel}>
        <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
          ...
          <TouchableOpacity style={styles.primaryButton} onPress={onRegisterResident}>
            <Text style={styles.primaryButtonText}>Cadastrar Novo Morador!</Text>
          </TouchableOpacity>
